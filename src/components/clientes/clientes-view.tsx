              ...
              ({ c, totalSpent, purchaseCount, lastPurchase, segment: seg }) => (
                <div key={c.id} className="rounded-lg border border-[var(--border)] p-3">
                  <div className="flex items-start justify-between gap-2">
                    ...
                    <span className="capitalize text-xs text-[var(--foreground-muted)]">{seg}</span>
                  </div>
                  ...
                  <div className="mt-3 grid grid-cols-2 gap-2 text-xs">
                    ...
                    <p>
                      <span className="text-[var(--foreground-muted)]">Compras:</span>{" "}
                      <span className="font-medium tabular-nums">{purchaseCount}</span>
                    </p>
                    <p className="col-span-2">
                      <span className="text-[var(--foreground-muted)]">Última compra:</span>{" "}
              ...
              {rows.map(
                ({ c, totalSpent, purchaseCount, lastPurchase, segment: seg }) => (
                  <tr key={c.id}>
                    ...
                    <td className="max-w-[220px] truncate px-4 py-3 text-[var(--foreground-muted)]">
                      {c.phone || "—"} · {c.email || "—"}
                    </td>
          ...
          >
            ...
            <label className="block text-xs font-medium text-[var(--foreground-muted)]">
              ...
              <textarea
                ...
                rows={3}
                className="mt-1 w-full resize-y rounded-lg border border-[var(--border)] px-2 py-2 text-sm"
              />
            </label>
            <label className="block text-xs font-medium text-[var(--foreground-muted)]">
              Fecha de alta
